//
//  CardCollectionViewLayoutOptions.swift
...
/// The optional configuration of CarLensCollectionViewLayout. Use this if you need to customize `CardCollectionViewLayout`.
public struct CardCollectionViewLayoutOptions {
    ...
    public init(minimumSpacing: CGFloat = 0, decelerationRate: UIScrollView.DecelerationRate = UIScrollView.DecelerationRate.normal, shouldShowScrollIndicator: Bool = false, itemSize: CGSize? = nil) {
